...
<template>
  <section class="panel-shell panel-accent p-6 md:p-7">
    ...
    <div v-if="!document" class="mt-6 border border-white/8 bg-white/4 p-5 text-sm text-slate-400">
    ...
    <template v-else>
      <div class="mt-6 flex flex-wrap gap-2">
        <span
          ...
          class="signal-pill text-slate-200"
        >
          {{ signal.matchedText }}
        </span>
      </div>
      ...
      <div class="scan-divider mt-6 pt-6">
        <div class="flex flex-wrap items-center gap-3 text-sm text-slate-400">
          ...
          <span class="h-px w-3 bg-slate-500" />
      ...
      <div class="mt-6 space-y-4">
        <article
          ...
          class="border border-white/8 bg-slate-950/55 px-4 py-4 scroll-mt-6 transition"
