...
<template>
  <section class="panel-shell rounded-[1.4rem] p-6 md:p-7">
    ...
    <div class="mt-6 space-y-6">
      <article
        ...
        :key="question.key"
        class="rounded-[1.15rem] border border-white/8 bg-white/4 p-4"
      >
        ...
        <select
          ...
          class="mt-4 w-full rounded-xl border border-white/10 bg-slate-950/70 px-3 py-3 text-sm text-slate-100 outline-none transition focus:border-amber-400/60"
        >
